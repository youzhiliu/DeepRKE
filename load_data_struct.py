...
Embepochs = 100
kmer_len = 3
struct_word2vec_model_31='./RNAShapes2Vec'
seq_word2vec_model_31='./RNA2Vec'

struct_word2vec_model_24='./RNAShapes2Vec_GraphProt'
seq_word2vec_model_24='./RNA2Vec_GraphProt'
...
def Load_Data(train_file,test_file,flag):
	...
	if flag == 'RBP31_struct':
		# model.save(struct_word2vec_model)
		model1 = gensim.models.Word2Vec.load(struct_word2vec_model_31)
	if flag == 'RBP31_seq':
		# model.save(seq_word2vec_model)
		model1 = gensim.models.Word2Vec.load(seq_word2vec_model_31)
	if flag == 'RBP24_struct':
		# model.save(struct_word2vec_model)
		model1 = gensim.models.Word2Vec.load(struct_word2vec_model_24)
	if flag == 'RBP24_seq':
		# model.save(seq_word2vec_model)
		model1 = gensim.models.Word2Vec.load(seq_word2vec_model_24)
...
if __name__ == "__main__":
	model1 = gensim.models.Word2Vec.load("./RNAShapes2Vec")
